...
export const useDataForView = (view, initialViewMeta, exView, initialExtendedView, silentFilters) => {
	...
	const {data: preData, isLoading} = useUserSpecificEntries(allKeys, JSON.parse(silentFilters));
	...
	const {data, filterParameters} = useWebWorker("../preparedataworker.js", {isLoading, preData, meta, moment, allOptionsWithData}, {data: [], filterParameters: {}});
