...
const updateUser = async (id, col, val) => {
	try {
		...
		console.log("trying to update user.." + col);
...
export const useDataForView = (view, initialViewMeta, exView, initialExtendedView, silentFilters, userId, totalLogins, allLogins) => {
