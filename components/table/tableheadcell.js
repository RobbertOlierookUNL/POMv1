...
const TableHeadCell = ({colMetaData, colName, requestSort, sortConfig, conversionMode}) => {
	...
	return (
		<div className="th" onClick={() => requestSort(colName, colMetaData.valuetype || allOptionsWithData.valuetype.default, conversionMode)}>
			{
